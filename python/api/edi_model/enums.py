...
class ReferenceType(EdiEnum):
    ...
    CLIA_NUMBER = "X4"
    REFERRING_CLIA_NUMBER = "F4"
    QUALIFIED_PRODUCT_LIST = "LX"
    BATCH_NUMBER = "BT"
    REFERRAL_NUMBER = "9F"
...
class IdentificationType(EdiEnum):
    ...
    UNKNOWN = "Unknown Identification Type"
...
class AttachmentTransmissionType(EdiEnum):
    AVAILABLE_ON_REQUEST_AT_PROVIDER_SITE = "AA"
    BY_MAIL = "BM"
...
class SpecialProgramType(EdiEnum):
    HANDICAPPED_CHILDRENS_PROGRAM = "02"
...
class PaymentAdjustmentReason(EdiEnum):
    pass


class RemittanceTransmissionType(EdiEnum):
    BY_MAIL = "BM"
    E_MAIL = "EM"
    FILE_TRANSFER = "FT"
    ON_LINE = "OL"
...
class TransactionType(EdiEnum):
    ...
    PAYMENT = "221A1"
    PHARMACY = "B1"
    MEMBER_COVERAGE = "220A1"
    CLAIM_ACK = "214"
    ALL = "ALL"
    UNKNOWN = "UNKNOWN"


class ObjectType(EdiEnum):
...
class PlaceOfServiceType(EdiEnum):
    OFFICE = "Office"
