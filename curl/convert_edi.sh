...
curl -F files=@"../edi_files/837/prof-encounter.dat" -F files=@"../edi_files/837/anesthesia.dat" "$API_URL/edi/json?ndjson=true"
# Or as regular JSON with array of claims
curl -F files=@"../edi_files/837/prof-encounter.dat" -F files=@"../edi_files/837/anesthesia.dat" "$API_URL/edi/json"
...
curl -H "Content-Type: text/plain" --data-binary @../edi_files/835/negotiated_discount.dat "$API_URL/edi/json?ediFileName=negotiated_discount.dat"
